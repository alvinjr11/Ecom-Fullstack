...
const ProductDetails = () => {
  ...
  return (
    <div className='container mx-auto p-4'>
      ...
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4 px-auto lg:px-0 mx-auto'>
          {/***product Image */}
          <div className='h-96 flex flex-col lg:flex-row-reverse gap-4'>

              <div className='h-[300px] w-[300px] lg:h-96 lg:w-96   bg-slate-200 relative p-2 mx-auto md:mx-0'>

        ...
        data.map((item,index)=>{
          return(
            <div key={item.userId+index} className=''>
              <p className='font-semibold text-lg pt-4 '>{moment(item.createdAt).format("LL")}</p>
          ...
          <div className='grid gap-1 '>
                {
                  item?.productDetails.map((product,index)=>{
                    return(
                      <div key={product.productId+index} className=' flex gap-3 bg-slate-100 p-3'>
                        <img 
                        src={product.image[0]}
              ...
              <div className=' flex flex-col  gap-4 lg:gap-6 p-2 min-w-[300px]'>
              <div>
              ...
              <div className='font-bold ml-auto w-fit lg:text-bold'>
